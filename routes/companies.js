...
router.get("/", async function (req, res, next) {
  try {
    ...
    if (criteria.minEmployees != undefined) {criteria.minEmployees = +criteria.minEmployees};
    if (criteria.maxEmployees != undefined) {criteria.maxEmployees = +criteria.maxEmployees};
